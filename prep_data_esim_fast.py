...
if __name__ == "__main__":
    ...
    parser.add_argument("--res", type=str, default='533:300',
                        help="Event camera resolution (e.g., '533:300')")
    parser.add_argument('--events_th_low', type=int, default=70000,
                        help='Lower threshold for limiting the number of events within an event window. None to ignore.')
    parser.add_argument('--events_th_high', type=int, default=300000,
                        help='Upper threshold for limiting the number of events within an event window. None to ignore.')
    parser.add_argument('--kp_th', type=int, default=50,
                        help='Keypoint threshold for rejecting blank frames. None to ignore.')
    parser.add_argument('--sd_th', type=float, default=None,
                        help='Standard deviation threshold. None to ignore.')
    parser.add_argument('--range_th', type=int, default=None,
                        help='Range (max value - min value) threshold. None to ignore.')
    parser.add_argument('--th_hist', type=float, default=99.9,
