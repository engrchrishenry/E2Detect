...
class E_FPN(nn.Module):
    ...
    def forward(self, image):
        ...
        feat = self.feature_head(res_pix)
        feat = F.adaptive_avg_pool2d(feat, (38, 38))

        return feat


if __name__ == '__main__':
    dct_min_path = '/storage4tb/PycharmProjects/GitHub/E2Detect/dct_min_new.npy'
    dct_max_path = '/storage4tb/PycharmProjects/GitHub/E2Detect/dct_max_new.npy'
    vox = torch.rand(1, 5, 300, 300).cuda()

    model = E_FPN(dct_min_path, dct_max_path).cuda()
